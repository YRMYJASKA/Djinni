SOURCE_FILES=src/cmdline.cpp src/file.cpp src/screen.cpp src/runtime.cpp src/settings.cpp src/miscellaneous.cpp src/commands.cpp
SOURCE_OBJ=cmdline.o file.o screen.o runtime.o settings.o miscellaneous.o commands.o
C_MAIN=src/main.cpp 
